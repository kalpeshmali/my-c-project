/*@file CDLL_Menu.c 
    @brief  Menu for Circular Double Linked List operations
    @author kalpesh mali 
*/
#include "CDLL_Menu.h"
#include <stdio.h>
...
/*  Function to display the menu options  
    @fun This function displays the available operations for the circular double linked list 
...
{
    int choice;
    printf("**************** WELCOME TO CIRCULAR DOUBLE LINK LIST OPERATION ****************\n");
